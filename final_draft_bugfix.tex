...
for $R_n \sim N(0,I_{3d})$. However, due to the singularity $\frac{1}{u_t}$, this method may be unstable in the sense that, for sufficiently large step sizes, it may fail to be ergodic and the moments of the numerical solution can grow without bound.
