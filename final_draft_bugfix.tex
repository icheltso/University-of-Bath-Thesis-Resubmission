...
By uniqueness of solutions, the processes generated by~(\ref{cyl})
and~(\ref{uvproc}) agree whenever the initial conditions agree.
Therefore $(u,v)_t$ is well posed on
$\mathcal X=\mathbb R_+^d\times\mathbb R^d$, is strong Feller and
irreducible, and the law of $(u,v)_t$ is obtained as the cylindrical
marginal of the law of $x_t$ whenever the initial distribution of
$x_0$ is cylindrical. Finally, the moment bounds for $x_t$ imply the
required moment bounds for $(u,v)_t$.
\end{proof}
