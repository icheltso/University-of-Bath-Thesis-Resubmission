...
The thesis also examines stochastic bilevel optimization for hyperparameter selection. We analyze methods such as stocBio and propose stoc-HOAG, a stochastic variant of the HOAG algorithm. A central theme of these chapter is the conditioning of the inner optimization problem.
...
\begin{enumerate}
    ...
    \item Contributions to stochastic bilevel optimization, including the proposal of stoc-HOAG and analysis of conditioning issues, together with a perspective on how Hadamard-based techniques could be integrated with bilevel methods for nonsmooth settings.
    \begin{mdframed}[hidealllines=true,backgroundcolor=yellow!20]
    Need to find a way to link hadamard-langevin to last chapter.
\end{mdframed}
\end{enumerate}

By placing Hadamard reparameterizations at the heart of sampling and connecting them to optimization, this thesis advances the theory of nonsmooth Bayesian inference. Its main impact lies in providing practical sampling algorithms with theoretical guarantees and practical applications.
